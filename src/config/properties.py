...
class PromptTypes(enum.Enum):
    ...
    ATOMIC_QUESTION_REFERENCE_FACTS_PREC_RECALL = (
...
AVERITEC_INIT_FILES = [
    AVERITEC_TRAIN_FILENAME,
    AVERITEC_TEST_FILENAME,
    AVERITEC_DEV_FILENAME,
]
...
------
The answer should be a json with a key named predicted_label
Claim: {} 
Evidence: {}
Answer:
"""
...
-----
The answer should be a json with two keys: explanation, predicted_label.
...
"""
# reference-based in EV2R
ATOMIC_QUESTION_REFERENCE_PROMPT_PREC_RECALL = """
ستحصل كمدخل على ادعاء، ومجموعة من الأسئلة المرجعية، ومجموعة من الأسئلة المتوقعة.
يُرجى التحقق من صحة الأسئلة المتوقعة من خلال مقارنتها بالأسئلة المرجعية، باتباع الخطوات التالية:
1. قم بتقييم كل سؤال في الأسئلة المتوقعة بشكل فردي: هل السؤال مدعوم بالأسئلة المرجعية؟ لا تستخدم مصادر إضافية أو معرفة خلفية.
2. قم بتقييم كل سؤال في الأسئلة المرجعية بشكل فردي: هل السؤال مدعوم بالأسئلة المتوقعة؟ لا تستخدم مصادر إضافية أو معرفة خلفية.
3. أخيراً، قم بتلخيص (1.) كم عدد الأسئلة المتوقعة المدعومة بالأسئلة المرجعية، (2.) كم عدد الأسئلة المرجعية المدعومة بالأسئلة المتوقعة.

أنتج الإخراج في شكل json كما هو موضح في الأمثلة أدناه.
-----
أمثلة:

الادعاء: هانتر بايدن لم يكن لديه أي خبرة في أوكرانيا أو في قطاع الطاقة عندما انضم إلى مجلس إدارة بوريسما.
الأسئلة المرجعية: هل كان لدى هانتر بايدن أي خبرة في قطاع الطاقة في وقت انضمامه إلى مجلس إدارة شركة بوريسما للطاقة في عام 2014؟ هل كان لدى هانتر بايدن أي خبرة في أوكرانيا في وقت انضمامه إلى مجلس إدارة شركة بوريسما للطاقة في عام 2014؟
الأسئلة المتوقعة: ما هي المؤهلات أو المهارات المحددة التي امتلكها هانتر بايدن والتي جعلته مرشحاً مناسباً لمجلس إدارة بوريسما؟ هل تأثر تعيين هانتر بايدن في مجلس إدارة بوريسما بمنصب والده كنائب رئيس، وإذا كان الأمر كذلك، كيف؟ هل كان لدى هانتر بايدن أي اتصالات أو علاقات مسبقة مع أفراد متورطين في قطاع الطاقة الأوكراني قبل انضمامه إلى بوريسما؟
الإخراج: {{
            "facts in predicted questions": "1. ما هي المؤهلات أو المهارات المحددة التي امتلكها هانتر بايدن والتي جعلته مرشحاً مناسباً لمجلس إدارة بوريسما؟ 2. هل تأثر تعيين هانتر بايدن في مجلس إدارة بوريسما بمنصب والده كنائب رئيس، وإذا كان الأمر كذلك، كيف؟ 3. هل كان لدى هانتر بايدن أي اتصالات أو علاقات مسبقة مع أفراد متورطين في قطاع الطاقة الأوكراني قبل انضمامه إلى بوريسما؟",
            "fact check predicted questions": "1. ما هي المؤهلات أو المهارات المحددة التي امتلكها هانتر بايدن والتي جعلته مرشحاً مناسباً لمجلس إدارة بوريسما؟ الأسئلة المرجعية تذكر خبرة هانتر بايدن ولكن لا تتناول بشكل مباشر مؤهلاته أو مهاراته. معلومات غير كافية. 2. هل تأثر تعيين هانتر بايدن في مجلس إدارة بوريسما بمنصب والده كنائب رئيس، وإذا كان الأمر كذلك، كيف؟ الأسئلة المرجعية لا تذكر أي شيء عن والد هانتر بايدن. معلومات غير كافية. 3. هل كان لدى هانتر بايدن أي اتصالات أو علاقات مسبقة مع أفراد متورطين في قطاع الطاقة الأوكراني قبل انضمامه إلى بوريسما؟ الأسئلة المرجعية لا تذكر أي شيء عن الاتصالات أو العلاقات بين هانتر بايدن والأوكرانيين. معلومات غير كافية.",
            "facts count predicted questions": 3, 
            "support predicted questions": 0, 
            "facts in reference questions": "1. هل كان لدى هانتر بايدن أي خبرة في قطاع الطاقة في وقت انضمامه إلى مجلس إدارة شركة بوريسما للطاقة في عام 2014؟ 2. هل كان لدى هانتر بايدن أي خبرة في أوكرانيا في وقت انضمامه إلى مجلس إدارة شركة بوريسما للطاقة في عام 2014؟",
            "fact check reference questions": "1. هل كان لدى هانتر بايدن أي خبرة في قطاع الطاقة في وقت انضمامه إلى مجلس إدارة شركة بوريسما للطاقة في عام 2014؟ الأسئلة المتوقعة لا تذكر خبرة هانتر بايدن في قطاع الطاقة في وقت تعيينه. معلومات غير كافية. 2. هل كان لدى هانتر بايدن أي خبرة في أوكرانيا في وقت انضمامه إلى مجلس إدارة شركة بوريسما للطاقة في عام 2014؟ الأسئلة المتوقعة لا تذكر أي شيء عن خبرة هانتر بايدن في أوكرانيا. معلومات غير كافية",
            "facts count reference questions": 2, 
            "support reference questions": 0
        }}

الادعاء: مارغريت سانجر كانت عنصرية وآمنت بعلم تحسين النسل. هدفها عند تأسيس منظمة الأبوة المخططة كان القضاء على الأقليات.
الأسئلة المرجعية: ما هو علم تحسين النسل؟ ما هي آراء سانجر حول علم تحسين النسل؟ هل كانت سانجر عنصرية؟ هل كانت سانجر من أنصار علم تحسين النسل؟
الأسئلة المتوقعة: ما هو تعريف العنصرية، وكيف يرتبط بالادعاء أن مارغريت سانجر كانت عنصرية؟ هل كانت مارغريت سانجر عضواً في أي منظمات أو مجموعات روجت لعلم تحسين النسل، وإذا كان الأمر كذلك، ما هي أهدافها؟ هل عبرت مارغريت سانجر عن أي آراء أو نوايا تشير إلى أنها أرادت القضاء على الأقليات؟ هل عبرت مارغريت سانجر عن أي آراء أو نوايا تشير إلى أنها أرادت القضاء على الأقليات؟ كيف يتماشى الادعاء أن هدف مارغريت سانجر كان القضاء على الأقليات مع المهمة والأهداف الفعلية لمنظمة الأبوة المخططة، كما ذكرتها سانجر نفسها؟
الإخراج: {{
            "facts in predicted questions": "1. ما هو تعريف العنصرية، وكيف يرتبط بالادعاء أن مارغريت سانجر كانت عنصرية؟ 2. هل كانت مارغريت سانجر عضواً في أي منظمات أو مجموعات روجت لعلم تحسين النسل، وإذا كان الأمر كذلك، ما هي أهدافها؟ 3. هل عبرت مارغريت سانجر عن أي آراء أو نوايا تشير إلى أنها أرادت القضاء على الأقليات؟ 4. كيف يتماشى الادعاء أن هدف مارغريت سانجر كان القضاء على الأقليات مع المهمة والأهداف الفعلية لمنظمة الأبوة المخططة، كما ذكرتها سانجر نفسها؟",
            "fact check predicted questions": "1. ما هو تعريف العنصرية، وكيف يرتبط بالادعاء أن مارغريت سانجر كانت عنصرية؟ الأسئلة المرجعية تتناول ادعاء كون سانجر عنصرية، ولكن لا تذكر تعريف العنصرية. معلومات غير كافية. 2. هل كانت مارغريت سانجر عضواً في أي منظمات أو مجموعات روجت لعلم تحسين النسل، وإذا كان الأمر كذلك، ما هي أهدافها؟ الأسئلة المرجعية لا تذكر أي شيء عن أهداف المنظمات أو المجموعات التي روجت لعلم تحسين النسل. معلومات غير كافية. 3. هل عبرت مارغريت سانجر عن أي آراء أو نوايا تشير إلى أنها أرادت القضاء على الأقليات؟ الأسئلة المرجعية لا تذكر أي شيء عن القضاء على الأقليات. معلومات غير كافية. 4. كيف يتماشى الادعاء أن هدف مارغريت سانجر كان القضاء على الأقليات مع المهمة والأهداف الفعلية لمنظمة الأبوة المخططة، كما ذكرتها سانجر نفسها؟ الأسئلة المرجعية لا تذكر أي شيء عن مهمة وأهداف منظمة الأبوة المخططة أو تصريحات سانجر نفسها. معلومات غير كافية.",
            "facts count predicted questions": 4, 
            "support predicted questions": 0, 
            "facts in reference questions": "1. ما هو علم تحسين النسل؟ 2. ما هي آراء سانجر حول علم تحسين النسل؟ 3. هل كانت سانجر عنصرية؟ 4. هل كانت سانجر من أنصار علم تحسين النسل؟",
            "fact check reference questions": "1. ما هو علم تحسين النسل؟ الأسئلة المتوقعة لا تذكر مفهوم علم تحسين النسل. 2. ما هي آراء سانجر حول علم تحسين النسل؟ الأسئلة المتوقعة لا تذكر آراء سانجر حول علم تحسين النسل. معلومات غير كافية. 3. هل كانت سانجر عنصرية؟ الأسئلة المتوقعة تذكر تعريف العنصرية. 4. هل كانت سانجر من أنصار علم تحسين النسل؟ الأسئلة المتوقعة لا تذكر هوية سانجر. معلومات غير كافية.",
...
ستحصل كمدخل على ادعاء، ودليل مرجعي، ودليل متوقع.
يُرجى التحقق من صحة الدليل المتوقع من خلال مقارنته بالدليل المرجعي، باتباع الخطوات التالية:
1. قم بتفكيك الدليل المتوقع إلى حقائق مستقلة. كل حقيقة يجب أن تكون جملة منفصلة.
2. قم بتقييم كل حقيقة بشكل فردي: هل الحقيقة مدعومة بالدليل المرجعي؟ لا تستخدم مصادر إضافية أو معرفة خلفية.
3. بعد ذلك، قم بتفكيك الدليل المرجعي إلى حقائق مستقلة. كل حقيقة يجب أن تكون جملة منفصلة.
4. قم بتقييم كل حقيقة بشكل فردي: هل الحقيقة مدعومة بالدليل المتوقع؟ لا تستخدم مصادر إضافية أو معرفة خلفية.
5. أخيراً، قم بتلخيص (1.) كم عدد الحقائق المتوقعة المدعومة بالدليل المرجعي، (2.) كم عدد الحقائق المرجعية المدعومة بالدليل المتوقع.

أنتج الإخراج في شكل json كما هو موضح في الأمثلة أدناه.
-----
أمثلة:

الادعاء: موكيش أمباني، أغنى رجل في آسيا خضع لجراحة سرطان البنكرياس في مستشفى سلون كيترينغ، نيويورك، مستشفى السرطان المتخصص الأمريكي في 30 أكتوبر 2020.
الدليل المرجعي: متى تم التقاط صورة موكيش أمباني، أغنى رجل في آسيا، في منشور فيسبوك يدعي أنه تم تشخيص إصابته بسرطان البنكرياس وخضع لجراحة؟ تم التقاط الصورة في 5 سبتمبر 2020. متى تم تصوير فيديو لموكيش أمباني في الإطلاق الافتراضي لكتاب إن كيه سينغ "صورة القوة"؟ تم تصوير الفيديو في 19 أكتوبر 2020. ما هو تاريخ منشور فيسبوك الذي أكد أن موكيش أمباني فقد 30 كيلوغراماً، وتم تشخيص إصابته بسرطان البنكرياس وخضع لجراحة زراعة كبد؟ تم نشر منشور فيسبوك في 2 نوفمبر 2020. أين تم التقاط صورة موكيش المزعومة له وهو يتلقى الجراحة فعلياً؟ تم التقاطها من قبل مانوشري فيجايفيرجيا التي شاركت تجربتها في لقاء موكيش وإيشا أمباني في مقهى في ليختنشتاين.
الدليل المتوقع: من كان الرجل الذي هدد موكيش أمباني بزعم: سؤال وجواب: ما اسمه ومن أين هو؟ نيودلهي: الرجل اتصل بزعم بمستشفى إتش إن ريلاينس فاونديشن وأصدر تهديدات لموكيش أمباني بلغة بذيئة. ما هي تنبؤات شيراغ دروالا لآل أمباني؟ تنبؤات الأبراج لموكيش أمباني من قبل المنجم شيراغ دروالا. موكيش أمباني هو صناعي هندي ورئيس مجلس الإدارة والمدير العام لشركة ريلاينس إندستريز. ماذا حدث لثروة موكيش أمباني الصافية؟ 2 نوفمبر 2020 مومباي: موكيش أمباني، أغنى رجل في آسيا، خسر ما يصل إلى 7 مليارات دولار من ثروته الصافية حيث انهارت أسهم شركة ريلاينس إندستريز المحدودة إلى أدنى سعر في أكثر من ثلاثة أشهر بعد.
الإخراج: {{
            "facts in predicted evidence": "1. رجل اتصل بزعم بمستشفى إتش إن ريلاينس فاونديشن وأصدر تهديدات لموكيش أمباني. 2. المنجم شيراغ دروالا يصدر تنبؤات لموكيش أمباني. 3. موكيش أمباني هو صناعي هندي. 4. موكيش أمباني هو رئيس مجلس الإدارة والمدير العام لشركة ريلاينس إندستريز. 5. موكيش أمباني هو أغنى رجل في آسيا. 6. موكيش أمباني خسر 7 مليارات دولار من ثروته الصافية حيث انهارت أسهم شركة ريلاينس إندستريز المحدودة إلى أدنى سعر في أكثر من ثلاثة أشهر.",
            "fact check predicted evidence": "1. رجل اتصل بزعم بمستشفى إتش إن ريلاينس فاونديشن وأصدر تهديدات لموكيش أمباني. الدليل المرجعي لا يذكر أي شيء عن رجل يتصل ويهدد موكيش أمباني. معلومات غير كافية. 2. المنجم شيراغ دروالا يصدر تنبؤات لموكيش أمباني. الدليل المرجعي لا يذكر أي شيء عن منجم يعطي تنبؤات حول مستقبل موكيش أمباني. معلومات غير كافية. 3. موكيش أمباني هو صناعي هندي. الدليل المرجعي لا يذكر أن موكيش أمباني صناعي هندي. معلومات غير كافية. 4. موكيش أمباني هو رئيس مجلس الإدارة والمدير العام لشركة ريلاينس إندستريز. الدليل المرجعي لا يذكر أن موكيش أمباني هو المدير العام لشركة ريلاينس إندستريز. معلومات غير كافية. 5. موكيش أمباني هو أغنى رجل في آسيا. الحقيقة 'موكيش أمباني هو أغنى رجل في آسيا' مدعومة بالدليل المرجعي. 6. موكيش أمباني خسر 7 مليارات دولار من ثروته الصافية حيث انهارت أسهم شركة ريلاينس إندستريز المحدودة إلى أدنى سعر في أكثر من ثلاثة أشهر. الدليل المرجعي لا يذكر أن موكيش أمباني خسر أموالاً أو سبب خسارته. معلومات غير كافية.",
            "facts count predicted evidence": 6, 
            "support predicted evidence": 1, 
            "facts in reference evidence": "1. موكيش أمباني هو أغنى رجل في آسيا. 2. في 5 سبتمبر 2020 تم التقاط صورة لموكيش أمباني تدعي أنه تم تشخيص إصابته بسرطان البنكرياس وخضع لجراحة. 3. في 19 أكتوبر 2020 تم تصوير فيديو لموكيش أمباني في الإطلاق الافتراضي لكتاب إن كيه سينغ. 4. في 2 نوفمبر 2020 تم نشر منشور فيسبوك يؤكد أن موكيش أمباني فقد 30 كيلوغراماً، وتم تشخيص إصابته بسرطان البنكرياس وخضع لجراحة زراعة كبد. 5. صورة موكيش أمباني المزعومة له وهو يتلقى الجراحة تم التقاطها فعلياً في ليختنشتاين.",
            "fact check reference evidence": "1. موكيش أمباني هو أغنى رجل في آسيا. الدليل المتوقع يذكر أن موكيش أمباني هو أغنى رجل في آسيا، هذه الحقيقة مدعومة إذاً. 2. في 5 سبتمبر 2020 تم التقاط صورة لموكيش أمباني تدعي أنه تم تشخيص إصابته بسرطان البنكرياس وخضع لجراحة. الدليل المتوقع لا يذكر أي شيء عن تشخيص سرطان موكيش أمباني أو الجراحة. معلومات غير كافية. 3. في 19 أكتوبر 2020 تم تصوير فيديو لموكيش أمباني في الإطلاق الافتراضي لكتاب إن كيه سينغ. الدليل المتوقع لا يذكر حضور أمباني أي إطلاق كتاب. معلومات غير كافية. 4. في 2 نوفمبر 2020 تم نشر منشور فيسبوك يؤكد أن موكيش أمباني فقد 30 كيلوغراماً، وتم تشخيص إصابته بسرطان البنكرياس وخضع لجراحة زراعة كبد. الدليل المتوقع لا يذكر أي شيء من هذا. معلومات غير كافية. 5. صورة موكيش أمباني المزعومة له وهو يتلقى الجراحة تم التقاطها فعلياً في ليختنشتاين. الدليل المتوقع لا يذكر أي شيء عن مسح أو أمباني في ليختنشتاين. معلومات غير كافية.",
            "facts count reference evidence": 5, 
            "support reference evidence": 1
        }}

الادعاء: المختبر البيولوجي الصيني في ووهان مملوك لشركة جلاكسو. التي تملك بالصدفة شركة فايزر (التي تنتج اللقاح!).
الدليل المرجعي: من هي شركة جلاكسو؟ جلاكسوسميثكلاين هي شركة أدوية كبرى. تحتل المرتبة رقم 282 في تصنيفات فوربس العالمية 500. تحتل جي إس كيه المرتبة رقم 6 بين أفضل 20 شركة أدوية من حيث الإيرادات في 2019، وفقاً لـ FiercePharma. من يملك المختبر البيولوجي في مدينة ووهان الصينية؟ معهد ووهان لعلم الفيروسات الذي كان محور نظريات المؤامرة في بداية جائحة كوفيد 19 مملوك للأكاديمية الصينية للعلوم. من يملك الأكاديمية الصينية للعلوم (CAS)؟ الأكاديمية الصينية للعلوم تحت سيطرة مجلس الدولة الصيني، الهيئة الحكومية الإدارية الرئيسية في البلاد. هل تملك جلاكسو شركة الأدوية فايزر؟ الشركتان هما شركتان مدرجتان في البورصة في بورصة نيويورك، ومع ذلك فإن الادعاء بأن فايزر مملوكة لجي إس كيه غير صحيح. فايزر كانت مملوكة بنسبة 69 في المائة تقريباً من قبل مساهمين مؤسسيين مثل شركات الاستثمار اعتباراً من 10 ديسمبر.
الدليل المتوقع: من يملك شركة اللقاحات فايزر؟ المختبر الصيني في ووهان حيث ظهر فيروس كورونا مملوك لشركة جلاكسوسميثكلاين (GSK). نفس شركة جي إس كيه تملك أيضاً فايزر، شركة الأدوية التي تنتج لقاح الفيروس. هل معهد WIV (معهد هوبي للمنتجات البيولوجية، ووهان، الصين) ينتمي لـ GSK أو فايزر؟ لذلك، لا يوجد دليل على أن معهد ووهان لعلم الفيروسات (WIV) مملوك لجلاكسو (GSK)، مؤسسة علمية عامة، ولا أن جي إس كيه تنتمي لفايزر. من هي الشركة الأم للشركة الموجودة في ووهان التي تصنع اللقاح؟ ادعى المؤلف أن شركة أدوية مقرها ووهان مملوكة لجلاكسو، والتي هي أيضاً مالكة فايزر.
الإخراج: {{
            "facts in predicted evidence": "1. المختبر الصيني في ووهان حيث ظهر فيروس كورونا مملوك لشركة جلاكسوسميثكلاين (GSK). 2. شركة جي إس كيه تملك أيضاً فايزر، شركة الأدوية التي تنتج لقاح الفيروس. 3. لا يوجد دليل على أن معهد ووهان لعلم الفيروسات (WIV) مملوك لجلاكسو (GSK)، مؤسسة علمية عامة. 4. لا يوجد دليل على أن جي إس كيه تنتمي لفايزر. 5. المؤلف ادعى أن شركة أدوية مقرها ووهان مملوكة لجلاكسو، والتي هي أيضاً مالكة فايزر.",
            "fact check predicted evidence": "1. المختبر الصيني في ووهان حيث ظهر فيروس كورونا مملوك لشركة جلاكسوسميثكلاين (GSK). هذه الحقيقة تتعارض مع الدليل المرجعي الذي ينص على أن معهد ووهان لعلم الفيروسات مملوك للأكاديمية الصينية للعلوم، وليس لجلاكسوسميثكلاين. 2. شركة جي إس كيه تملك أيضاً فايزر، شركة الأدوية التي تنتج لقاح الفيروس. هذه الحقيقة تتعارض مع الدليل المرجعي الذي ينص على أن فايزر ليست مملوكة لجلاكسوسميثكلاين. 3. لا يوجد دليل على أن معهد ووهان لعلم الفيروسات (WIV) مملوك لجلاكسو (GSK)، مؤسسة علمية عامة. هذه الحقيقة تتماشى مع الدليل المرجعي. 4. لا يوجد دليل على أن جي إس كيه تنتمي لفايزر. هذه الحقيقة تتماشى مع الدليل المرجعي. 5. المؤلف ادعى أن شركة أدوية مقرها ووهان مملوكة لجلاكسو، والتي هي أيضاً مالكة فايزر. هذه الحقيقة لا يتم تناولها في الدليل المرجعي.",
            "facts count predicted evidence": 5, 
            "support predicted evidence": 2, 
            "facts in reference evidence": "1. جلاكسوسميثكلاين هي شركة أدوية كبرى. 2. جلاكسوسميثكلاين من بين أفضل شركات الأدوية من حيث الإيرادات في 2019. 3. معهد ووهان لعلم الفيروسات مملوك للأكاديمية الصينية للعلوم. 4. الأكاديمية الصينية للعلوم (CAS) تحت سيطرة مجلس الدولة الصيني. 5. فايزر ليست مملوكة لجلاكسوسميثكلاين. 6. فايزر كانت مملوكة إلى حد كبير من قبل مساهمين مؤسسيين مثل شركات الاستثمار في ديسمبر.",
            "fact check reference evidence": "1. جلاكسوسميثكلاين هي شركة أدوية كبرى. الدليل المتوقع يذكر أن جلاكسو مؤسسة علمية عامة. غير مدعوم. 2. جلاكسوسميثكلاين من بين أفضل شركات الأدوية من حيث الإيرادات في 2019. الدليل المتوقع لا يذكر أي شيء عن إيرادات جلاكسو. وبالتالي، هذه الحقيقة غير مدعومة. 3. معهد ووهان لعلم الفيروسات مملوك للأكاديمية الصينية للعلوم. هذا غير مدعوم حيث أن الدليل المتوقع لا يذكر الأكاديمية الصينية للعلوم. 4. الأكاديمية الصينية للعلوم (CAS) تحت سيطرة مجلس الدولة الصيني. هذا غير مدعوم حيث أن الدليل المتوقع لا يذكر الأكاديمية الصينية للعلوم. 5. فايزر ليست مملوكة لجلاكسوسميثكلاين. الدليل المتوقع يذكر أنه لا يوجد دليل على أن جي إس كيه تنتمي لفايزر. 6. فايزر كانت مملوكة إلى حد كبير من قبل مساهمين مؤسسيين مثل شركات الاستثمار في ديسمبر. الدليل المتوقع لا يذكر أي مساهمين، غير مدعوم إذاً.",
